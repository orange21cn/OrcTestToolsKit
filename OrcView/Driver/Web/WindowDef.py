...
class WindowDefModel(ModelTree):

    def __init__(self):

        ModelTree.__init__(self)

        _base_url = 'http://localhost:5000/WindowDef'
        _interface = {
...
class WindowDefControl(LibControl):
...
class ViewWindowDefMag(QWidget):
    ...
    def __init__(self, p_def):
        ...
        # Control
        _control = WindowDefControl(_table_def)
