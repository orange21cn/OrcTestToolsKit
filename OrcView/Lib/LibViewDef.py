...
view_data = [
    ...
    dict(ID="data_type", NAME=u"数据类型", TYPE="SELECT",
         DISPLAY=True, EDIT=True, SEARCH=False, ADD=True, ESSENTIAL=True),
    dict(ID="data_mode", NAME=u"数据来源", TYPE="SELECT",
         DISPLAY=True, EDIT=True, SEARCH=False, ADD=True, ESSENTIAL=True),
    # dict(ID="data_src_type", NAME=u"数据源", TYPE="DATASRC",
    #      DISPLAY=True, EDIT=True, SEARCH=True, ADD=True, ESSENTIAL=False),
    dict(ID="data_value", NAME=u"数据", TYPE="DATA_EDIT",
