...
init_value_dictionary = [
    ...
    LibDictionary(dict(id="10022", dict_flag="widget_attr_type", dict_order="4",
                       dict_value="LINK_TEXT", dict_text=u"链接文字", dict_desc="")),
    LibDictionary(dict(id="10023", dict_flag="widget_attr_type", dict_order="4",
                       dict_value="CSS", dict_text="CSS", dict_desc="")),
    LibDictionary(dict(id="10024", dict_flag="src_type", dict_order="1",
                       dict_value="BATCH", dict_text=u"计划", dict_desc="")),
    LibDictionary(dict(id="10025", dict_flag="src_type", dict_order="2",
                       dict_value="CASE", dict_text=u"用例", dict_desc="")),
    LibDictionary(dict(id="10026", dict_flag="src_type", dict_order="3",
                       dict_value="STEP", dict_text=u"步骤", dict_desc="")),
    LibDictionary(dict(id="10027", dict_flag="src_type", dict_order="4",
                       dict_value="ITEM", dict_text=u"执行项", dict_desc="")),
    LibDictionary(dict(id="10028", dict_flag="operate_object_type", dict_order="1",
                       dict_value="PAGE", dict_text=u"页面", dict_desc="")),
    LibDictionary(dict(id="10029", dict_flag="operate_object_type", dict_order="2",
                       dict_value="WIDGET", dict_text=u"控件", dict_desc="")),
    LibDictionary(dict(id="10030", dict_flag="run_def_type", dict_order="1",
                       dict_value="BATCH", dict_text=u"计划", dict_desc="")),
    LibDictionary(dict(id="10031", dict_flag="run_def_type", dict_order="2",
                       dict_value="CASE", dict_text=u"用例", dict_desc="")),
    LibDictionary(dict(id="10032", dict_flag="run_def_type", dict_order="3",
                       dict_value="TEST", dict_text=u"执行记录", dict_desc="")),
    LibDictionary(dict(id="10033", dict_flag="run_det_type", dict_order="1",
                       dict_value="BATCH_GROUP", dict_text=u"计划组", dict_desc="")),
    LibDictionary(dict(id="10034", dict_flag="run_det_type", dict_order="2",
                       dict_value="BATCH", dict_text=u"计划", dict_desc="")),
    LibDictionary(dict(id="10035", dict_flag="run_det_type", dict_order="3",
                       dict_value="CASE_GROUP", dict_text=u"用例组", dict_desc="")),
    LibDictionary(dict(id="10036", dict_flag="run_det_type", dict_order="4",
                       dict_value="CASE", dict_text=u"用例", dict_desc="")),
    LibDictionary(dict(id="10037", dict_flag="run_det_type", dict_order="5",
                       dict_value="STEP", dict_text=u"步骤", dict_desc="")),
    LibDictionary(dict(id="10038", dict_flag="run_det_type", dict_order="6",
                       dict_value="ITEM", dict_text=u"步骤项", dict_desc="")),
    LibDictionary(dict(id="10039", dict_flag="test_env", dict_order="1",
                       dict_value="TEST", dict_text=u"测试环境", dict_desc="")),
    LibDictionary(dict(id="10040", dict_flag="test_env", dict_order="2",
                       dict_value="PRE", dict_text=u"预生产环境", dict_desc="")),
    LibDictionary(dict(id="10041", dict_flag="test_env", dict_order="6",
